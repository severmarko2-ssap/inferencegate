    ...
    <main className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      <nav className="border-b border-slate-700/50 bg-slate-900/50 backdrop-blur-sm sticky top-0 z-50">
        <div className="container py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <Image src="/logo-trans.png" alt="SSAP" width={40} height={40} className="h-10 w-10" />
      ...
      <footer className="border-t border-slate-700/50 py-10">
        <div className="container flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2"><Image src="/logo-trans.png" alt="SSAP" width={28} height={28} className="h-7 w-7" /><span className="font-bold text-white">SSAP</span></div>
